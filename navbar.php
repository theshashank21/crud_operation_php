...
<body>
    <nav class="navbar navbar-expand-lg bg-dark" style="margin-top: 0px; padding: 6px" data-bs-theme="dark">
        <div class="container align-middle">
            <a class="navbar-brand" style="font-size: 24px" href="index.php">MiniTaskForm</a>
            ...
            <div class="collapse navbar-collapse" style="right: 50px; position: absolute; font-size: 18px" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-0 mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" id="homeLink" aria-current="page" href="index.php">Home</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="searchingLink" href="searching.php">Searching</a>
                    </li>
                </ul>
            </div>
        </div>
